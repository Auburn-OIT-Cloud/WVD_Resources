...
param(
	...
	[Parameter(mandatory = $false)]
	[string]$ArtifactsURI = 'https://raw.githubusercontent.com/Auburn-OIT-Cloud/WVD_Resources/master/WVD_Scaling'
)
...
$ScriptURI = "$ArtifactsURI/scripts/newscale_Peak_and_offPeak.ps1"
if (!$UseRDSAPI) {
	$ScriptURI = "$ArtifactsURI/scripts/newscale_Peak_and_offPeak.ps1"
}
