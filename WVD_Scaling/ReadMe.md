 ...
 ### How to deploy    
  ...
  4. Create a runas account in the automation account settings for the script to use

  5. Run the following script to download the logic app builder script
     ```Powershell
     New-Item -ItemType Directory -Path "C:\Temp" -Force
     Set-Location -Path "C:\Temp"
     $Uri = "https://raw.githubusercontent.com/Auburn-OIT-Cloud/WVD_Resources/master/WVD_Scaling/CreateOrUpdateAzLogicApp.ps1"
     # Download the script
     Invoke-WebRequest -Uri $Uri -OutFile ".\CreateOrUpdateAzLogicApp.ps1"
     
     
  6. Run the following script to create the logic app   
     ```Powershell
     ...
     $WebhookURIAutoVar = Get-AzAutomationVariable -Name 'WebhookURIARMBased' -ResourceGroupName $AutoAccount.ResourceGroupName -AutomationAccountName
